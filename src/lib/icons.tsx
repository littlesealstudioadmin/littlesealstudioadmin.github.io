...
import { RiLinkedinBoxFill, RiInstagramFill, RiYoutubeFill, RiFacebookBoxFill, RiBlueskyFill, RiRedditFill, RiThreadsFill, RiMastodonFill, RiTumblrFill, RiTwitterFill, RiTwitterXFill, RiDiscordFill, RiSteamFill, RiTwitchFill, RiMediumFill, RiGithubFill, RiGitlabFill, RiBehanceFill, RiDribbbleFill, RiMapPinLine, RiMapPinFill, RiMailLine, RiMailFill, RiMapFill, RiPhoneFill, RiPhoneLine, RiGlobalLine, RiGlobalFill, RiKakaoTalkFill } from "@remixicon/react";
